...
| `SB_AGENT_ID` | n/a | (unset) | Agent UUID (env-var bootstrap) |
| `SB_AGENT_SECRET` | n/a | (unset) | Agent long-lived secret (env-var bootstrap) |
...
| `LOG_LEVEL` | n/a | `info` | `debug`/`info`/`warn`/`error` |
